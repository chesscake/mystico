...
label cd2_chat9_vn_ri():
    ...
    ri "Imagine - Jumin allowed you to come with me! I wasn't expecting him to."
    ri "He is a stickler for schedules"
    ja "Mr. Han occasionally grants me time off work"
    ja "Of course,  I'll have to make up for it as soon as this is over"
    show jaehee glasses sad
    ja "Seeing as I had to pull out of a bussines meeting for his cat projects to be able to come"
    ...
    ja "I mostly take care of Elizabeth. However, my job is open-ended, there is no one thing I have to do"
    ja "For example, Mr.Han could call an unplanned bussines meeting, and I have to move his schedule to account for it"
    ja "While also  making sure that Elizabeth's status is known at all times"
    ja "And whenever he wants me to stand in for him at meetings, he'll just come up to my desk and take me to the meeting himself"
    ja "Then he usually leaves, leaving me to deal with Elizabeth"
    ...
    ja "I'll manage"
    ja "And, of course, you had the best intentions at heart when you gave him Elizabeth."
    ...
    ri "Hmm...Don't think of it like that ! I wanted you to be a part of the RFA too. You have so much potential. "
    ri "And, I know this migh seem silly but...do you think the RFA can truly help people? I've been having some doubts recently and I'm not sure if we are doing enough"
    ri "Do you have any suggestions as to what you want us to do next?"
    show jaehee glasses neutral
    ja "Well, I'm not really sure about that. I feel as though the RFA is doing what it was intended for. I'm not exactly sure what else can be done"
    ...
    ja "And she would be flattered to hear it. She was always interested in charity work and helping those less advantegous than us"
    ...
    show rika neutral
    show jaehee glasses neutral
    ja "Well...it was the nurse who took care of her after her accident."
    ja "The details are fuzzy in my mind but..."
    ja "I remeber that she had long blond hair, and extremely striking eyes"
    ...
    show rika thinking
    ri "Oh ...do you perhaps remember her name?"
    ja "It's been a long time since that day and my memory might be messing with me but...It was something along the lines of Mei or Maeko"
    ja "Though I'm not really sure on that, it could have been a number of other things. The memory of that day is still etched into my mind, but the details got lost over time"
    ri "..."
    show jaehee glasses surprised
    ja "Oh, I'm sorry!I don't want to make you sad with my story! Should we change the subject?"
    ri "A nurse you say...and with a non-Korean sounding name? I wonder.."
    ja "What was that? Sorry, I didn't hear you Rika! Your voice seems to be trembling a little, and all this chatter around is making it hard to make out"
    show rika neutral
