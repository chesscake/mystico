label cd3_chat1():
    ...
    z "So, everyone.."
    z "I am happy to announce that it..."
    ...
    msg z "...which just so happens to be returning to theaters later this month"
    menu:
        "Oh wow Zen! That sounds so cool!":
            award heart z
    ...
    msg ja "OMG!!!" glow
    msg ja "I CAN'T BELIEVE I FORGOT!" glow
    ...
    menu:
        ...
        "Rika would be interested in something like this too":
            award heart ri
    ...
    ja "I guess I'll explain the musical a bit to [name]"
    ja "They used to hire two actors for the part Zen got"
    ja "One for his good, courageous side,"
    msg ja "and another for his evil counterpart" bold
    z "Yup! That's what the casting call said"
    z "However...they liked my acting so much that they wanted me in both roles!"
    msg z "I didn't get double the pay though" curly sigh_m
    msg z "But just being a part of such a big production did wonders for my career" ser1
    ...
    ja "The musical slightly changed the storyline..."
    msg ja "However, it ended up being just as interesting!" big bold glow
    msg ja "They had Zen in it, after all" sser2 big cloud_l
    ja "Sigh..."
    ja "I'm so pumped up,"
    ...
    menu:
        "Good night Jaehee! Hope you can get to see the musical again sometime soon!":
            award heart ja
            ja "I hope so too!!"
            msg ja "I'm already so excited!" glow bold
...
label cd3_chat1_expired():
    ...
    ja "..."
    ja "What could he have meant by that?"
    ja "Well, whatever it is.."
    ja "I hope he didn't go beyond his means to get it"
    ja "If any of the members are interested,"
    msg ja "I can try to give you all general outline of the story before heading to bed." bold glow
    ja "Basically,"
    msg ja "the storyline revolves around a tomboy princess called Helena who goes to a special school" ser1
    msg ja "There she meets and befriends Anne," ser1
    msg ja "a young girl who loves roses and animals" ser1
